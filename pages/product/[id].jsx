...
const Product = () => {
    ...
    const pizza = {
        ...
        desc: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt delectus aut, doloremque eos quibusdam laudantium."
    }
        ...
        <div className={styles.container}>
            <div className={styles.left}>
                <div className={styles.imgContainer}>
                    <Image objectFit='contain' layout='fill' src={pizza.img} alt='' />
                </div>
            </div>
